...
USAGE:
    python 10_06_grabcut.py <filename>
...
class App:
    ...
    def run(self):
        ...
        if len(sys.argv) == 2:
            ...
            print("Correct Usage: python 10_06_grabcut.py <filename> \n")
            # filename = 'fruits.jpg'
            # filename = 'GolyoAlszik_rs.jpg'
            filename = 'webcam_selfie.jpg'
        ...
        while True:
            ...
            if k == 27:          # esc to exit
                ...
                cv.imwrite('grabcut_output_01.png', self.img)
                cv.imwrite('grabcut_output_02.png', self.output)
